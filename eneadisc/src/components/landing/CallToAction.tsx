...
export const CallToAction: React.FC = () => {
  ...
  return (
    <section className="py-32 bg-slate-50 border-t border-slate-100 overflow-hidden">
        ...
        <Reveal delay={0.2} direction="up">
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <button 
              ...
              className="px-10 py-5 bg-slate-900 text-white text-sm font-medium tracking-wide hover:bg-slate-800 transition-all hover:-translate-y-1 hover:shadow-xl w-full sm:w-auto"
            >
              Configurar Empresa
            </button>
            <button 
            ...
            >
              Ingresar como Colaborador <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
            </button>
          </div>
        </Reveal>
      </div>
