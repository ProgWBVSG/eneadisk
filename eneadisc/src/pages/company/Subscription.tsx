...
const COLOR_MAP: Record<string, { bg: string; text: string; border: string; btn: string; badge: string }> = {
  ...
  blue:     { bg: 'bg-blue-50',   text: 'text-blue-700',  border: 'border-blue-200',  btn: 'bg-[#E07A5F] hover:bg-[#C9624A]',   badge: 'bg-blue-100 text-blue-700' },
  purple:   { bg: 'bg-[#FCF1EC]', text: 'text-[#A84C37]',border: 'border-[#F8DDD2]',btn: 'bg-[#E07A5F] hover:bg-[#C9624A]',badge: 'bg-[#E07A5F] text-white' },
